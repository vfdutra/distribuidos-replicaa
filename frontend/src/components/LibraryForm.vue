<template>
    <div class="form">
        ...
        <div
            class="alert alert-success center mx-5"
            role="alert"
            v-if="success"
        >
            {{ success }}
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div
                                class="col-12 mb-3"
                                v-else-if="selectedFilter === 'authors'"
                            >
                                <label for="authors" class="form-label"
                                    >Autores</label
                                >
    ...
    methods: {
        async handleSubmitNewBook() {
            try {
                ...
                this.error = "";
                this.success =
                    "Livro cadastrado com sucesso. Atualize a busca para conferir.";
                this.cleanModel();
            } catch (e) {
                this.success = "";
                this.error =
        ...
        async handleSubmitSearchBook() {
            try {
                ...
                const { data } = await api.get(`/books${filter}`);
                this.books = data;
                this.error = "";
            } catch (e) {
                this.error =
        ...
        cleanModel() {
            for (const att in this.model.newBook) {
                if (att === "edition" || att === "year")
                    this.model.newBook[att] = null;
